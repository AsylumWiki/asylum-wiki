...
export default () => {
  ...
  return defineConfig({
    lang: 'en',
    title: "AsylumWiki",
    description: "AsylumWiki is dedicated to providing information and resources to all those seeking protection from persecution and serious human rights violations",
    head:[
