...
::: danger 重要提示
時隔兩年重新開始維護，本站正在加快進行文件整理，部分內容可能已不具備時效性，請注意甄別與核實。

目前所有文件皆為第三方個人提供，作者觀點不代表AsylumWiki的立場。我們正在加快進行信源分類工作，目前不對任何內容的準確性、完整性、可靠性或適用性負責，請自行甄別與核實。
:::
...
版權所有 © 2024-2026 [AsylumWiki](https://asylum.wiki/)

本專案包含多項按不同許可條款授權的內容：

原始碼：本專案所有原始碼均按 [MIT許可條款](https://opensource.org/licenses/MIT) 授權發布。

文檔及非程式碼資源：本專案所有文檔及非程式碼資源均按 [共享創意 姓名標示─相同方式分享 4.0 國際 公眾許可條款 (CC BY-SA 4.0)](https://creativecommons.org/licenses/by-sa/4.0/legalcode.zh-hant) 授權發布。
